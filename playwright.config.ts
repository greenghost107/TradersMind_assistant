...
export default defineConfig({
  ...
  testMatch: ['**/bot-shutdown-cleanup.spec.ts', '**/hebrew-button-flow.spec.ts', '**/createbuttons-command.spec.ts', '**/symbol-detection.spec.ts', '**/dynamic-symbol-allowlist.spec.ts', '**/sofi-indexing-bug.spec.ts', '**/ibd-reference-filtering.spec.ts', '**/symbol-message-slash-command-not-indexed.spec.ts', '**/button-points-to-latest-analysis.spec.ts', '**/timestamp-comparison-simple.spec.ts'],
  fullyParallel: true,
